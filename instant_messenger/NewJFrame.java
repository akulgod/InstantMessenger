...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        useridlbl_signup = new javax.swing.JLabel();
        ...
        login.getContentPane().add(usernametxt_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 60, 255, 29));
        ...
        useridlbl_signup.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        useridlbl_signup.setText("User id");
                    ...
                    .addGroup(signupLayout.createSequentialGroup()
                        ...
                        .addGroup(signupLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(signupLayout.createSequentialGroup()
                                ...
                                .addGap(25, 25, 25))
                            .addGroup(signupLayout.createSequentialGroup()
                                .addComponent(useridlbl_signup, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(201, 201, 201))
    ...
    private void loginbtn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbtn_loginActionPerformed
        ...
        username = usernametxt_login.getText();
        pass = new String(usrpass_login.getPassword());
     
  if (username.equals("server") && (pass.equals("kvuc")))//severpagelogin
    {
     ...
     {
       try {
                query = "select userid, password, email, username, name from verify where username =" + "'" + username + "'" + ";";
    ...
    private void createuserbtn_signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createuserbtn_signupActionPerformed
        ...
        String email = inputusermail_signup.getText(),
                password = new String(inputpass_signup.getPassword()), 
      ...
      if(username!=null && name!=null && email!=null && password!=null)
      {
        ...
        try {
            ...
            query = "select userid, username, email from verify";
            rs = sqlexecutequery(query);
            while (rs.next())
            {
            ...
            {
                query = "select max(userid)+1 from verify";
                rs = sqlexecutequery(query);
                rs.next();
                userid = rs.getInt("max(userid)+1");
                useridlbl_signup.setText("User ID :" + userid);
    ...
    private void sendbtn_writeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendbtn_writeActionPerformed
        ...
        try {
            ...
            query = "select userid, username , email from verify where email= '" + mailto + "'";
            rs = sqlexecutequery(query);
            rs.next();
    ...
    private void Updatel_accsttngActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Updatel_accsttngActionPerformed
        ...
        try {
            query = "select userid, password, email from verify where username =" + "'" + username + "'" + ";";
            rs = sqlexecutequery(query);
            rs.next();
            //check old password
...
/*method to execute query*/
    ...
    private javax.swing.JLabel useridlbl_signup;
